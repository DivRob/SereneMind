      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center pb-8">
            ...
            <CardTitle className="text-2xl font-bold text-slate-800">Start Your Journey</CardTitle>
            <CardDescription className="text-slate-600">Create your account for personalized wellness</CardDescription>
          </CardHeader>
          <CardContent>
